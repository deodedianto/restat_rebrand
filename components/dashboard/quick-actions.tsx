...
export function QuickActions({ onScheduleClick, ordersCount = 0, referralPoints = 0 }: QuickActionsProps) {
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6">
      ...
      <Card className="border-0 bg-gradient-to-br from-emerald-100 via-teal-50 to-cyan-100 shadow-md hover:shadow-lg transition-shadow">
        <CardContent className="p-3 sm:p-4 lg:p-6">
          <button onClick={onScheduleClick} className="flex flex-col items-center text-center w-full">
